...
if [ $BUILD_EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo -e "${CYAN}Siguiente paso - Deploy a Railway:${NC}"
    echo -e "  ${YELLOW}./deploy-railway.sh${NC}"
    echo -e ""
    echo -e "${CYAN}O deploy desde GitHub:${NC}"
    echo -e "  1. ${YELLOW}git push origin main${NC}"
    echo -e "  2. Ir a ${YELLOW}https://railway.app${NC} → Deploy from GitHub"
    echo ""
else
    echo -e "${RED}╔════════════════════════════════════════════════════════╗${NC}"
