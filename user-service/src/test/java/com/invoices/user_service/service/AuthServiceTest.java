    ...
    class RegistrationTests {
        ...
        void shouldPropagateUserAlreadyExistsException() {
            ...
            when(userService.createUser(createUserRequest))
                    .thenThrow(new com.invoices.user_service.exception.UserAlreadyExistsException(
                            createUserRequest.getEmail()));

            // Act & Assert
            assertThatThrownBy(() -> authService.register(createUserRequest))
                    .isInstanceOf(com.invoices.user_service.exception.UserAlreadyExistsException.class);
