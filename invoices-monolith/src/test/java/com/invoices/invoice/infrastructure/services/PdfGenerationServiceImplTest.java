...
class PdfGenerationServiceImplTest {
    ...
    void generateInvoicePdf_ShouldGeneratePdf() {
        ...
        Company company = new Company(
                1L, "Test Company", "B12345678", "Address", "City", "28000", "Province", "600000000", "email@test.com",
                "ES0000000000000000000000");

        Client client = new Client(
                1L, "Test Client", "A87654321", "Address", "City", "28000", "Province", "600000000", "client@test.com");

        Invoice invoice = new Invoice(
                1L, company.getId(), client.getId(), "001/2024", LocalDateTime.now(), new BigDecimal("15.00"),
                new BigDecimal("5.20"));

        InvoiceItem item = new InvoiceItem(
                1L, 1L, "Test Item", 1, new BigDecimal("100.00"), new BigDecimal("21.00"), BigDecimal.ZERO);
