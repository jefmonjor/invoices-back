    ...
    private UserCompany toDomain(com.invoices.company.infrastructure.persistence.entities.UserCompany jpaEntity) {
        ...
        if (jpaEntity.getUser() != null) {
            ...
            com.invoices.user.domain.entities.User user = new com.invoices.user.domain.entities.User(
                    ...
                    jpaUser.getLastName(),
                    jpaUser.getRoles(),
                    Boolean.TRUE.equals(jpaUser.getEnabled()),
                    Boolean.TRUE.equals(jpaUser.getAccountNonExpired()),
                    Boolean.TRUE.equals(jpaUser.getAccountNonLocked()),
                    Boolean.TRUE.equals(jpaUser.getCredentialsNonExpired()),
