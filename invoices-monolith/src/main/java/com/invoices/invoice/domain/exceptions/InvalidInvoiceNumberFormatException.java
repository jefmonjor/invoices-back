...
public class InvalidInvoiceNumberFormatException extends RuntimeException {
    private static final String MESSAGE_TEMPLATE = "Invalid invoice number format: '%s'. Expected format: YYYY-XXX (e.g., 2025-001) or PREFIX-YYYY-XXX (e.g., INV-2025-001)";
