package com.invoices.user.infrastructure.persistence.entities;
 ...
 * This is the infrastructure representation of a User for database operations.
 * Separated from domain entity to follow Clean Architecture.
 */
@Entity
