        ...
        private Info apiInfo() {
                return new Info()
                                ...
                                .description("""
                                                ...
                                                - 📊 Audit logging
                                                - ✅ **VeriFactu** integration (AEAT digital invoicing)

                                                ### VeriFactu Integration
                                                - 📜 Digital certificate management (P12/PFX)
                                                - 🔏 XAdES-BES XML signatures
                                                - 📤 Automatic submission to AEAT
                                                - 📱 QR code generation for invoices
                                                - 🔄 Circuit breaker protection for AEAT calls

                                                ### Service Health
                                                - `GET /actuator/health` - Overall health status
                                                - `GET /actuator/health/minio` - Storage service
                                                - `GET /actuator/health/redisCustom` - Message queue
                                                - `GET /actuator/health/circuitBreakers` - Circuit breaker states
