...
# Environment for JVM optimization
ENV JAVA_OPTS="-Xmx450m -Xms256m -XX:MaxMetaspaceSize=300m -Xss512k -XX:+UseContainerSupport -XX:+ExitOnOutOfMemoryError -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp/heapdump.hprof -Djava.security.egd=file:/dev/./urandom"
